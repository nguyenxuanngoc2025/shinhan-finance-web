...
export const NEWS_ARTICLES: NewsArticle[] = [
  {
    ...
    excerpt: 'Lễ vui rộn ràng, săn thêm deal mới! Nhằm giúp Khách hàng khởi động cho kỳ nghỉ lễ rực rỡ sắp tới, Shinhan Finance kết hợp cùng Mobile World Group (MWG) mang đến ưu đãi mua sắm 1.000.000 VNĐ và lãi suất 0%.',
    content: `<p>Lễ vui rộn ràng, săn thêm deal mới!</p>
<p>Nhằm giúp Khách hàng khởi động cho kỳ nghỉ lễ rực rỡ sắp tới, Shinhan Finance kết hợp cùng Mobile World Group (MWG) mang đến ưu đãi mua sắm 1.000.000 VNĐ và lãi suất 0% khi Khách hàng chuyển đổi trả góp thành công bằng thẻ tín dụng THE FIRST.</p>
...
<p>Tải/ cập nhật iShinhan ngay hôm nay để trải nghiệm thanh toán mượt mà và không bỏ lỡ ưu đãi hấp dẫn từ Shinhan Finance.</p>`,
    category: 'khuyen-mai',
    date: '2026-01-28',
  ...
  },
  {
    ...
    title: 'Shinhan Finance được vinh danh "Đơn vị tiêu biểu trong hoạt động khai thác thông tin tín dụng năm 2025"',
    excerpt: 'Ngày 30/1/2026, Công ty Tài chính TNHH Một Thành Viên Shinhan Việt Nam (Shinhan Finance) đã vinh dự được xướng tên nhận giải thưởng "Đơn vị tiêu biểu trong hoạt động khai thác thông tin tín dụng năm 2025".',
    content: `<p>Ngày 30/1/2026, Công ty Tài chính TNHH Một Thành Viên Shinhan Việt Nam (Shinhan Finance) đã vinh dự được xướng tên nhận giải thưởng "Đơn vị tiêu biểu trong hoạt động khai thác thông tin tín dụng năm 2025". Sự kiện nằm trong khuôn khổ Hội nghị sơ kết Đề án phát triển Trung tâm Thông tin Tín dụng Quốc gia Việt Nam (CIC) giai đoạn 2022 - 2025.</p>
<p>Giải thưởng năm nay có ý nghĩa đặc biệt khi 2025 là năm bản lề, đánh dấu sự hoàn thành giai đoạn đầu của Đề án phát triển CIC và mở ra định hướng chiến lược đến năm 2030. Đáng chú ý, đây là lần thứ 3 Shinhan Finance được vinh danh tại hạng mục uy tín này.</p>
<h3>Đáp ứng chuẩn mực dữ liệu mới trong kỷ nguyên số</h3>
<p>Trong bối cảnh năm 2025 được xác định là năm ngành Ngân hàng đẩy mạnh chuyển đổi số và tinh gọn bộ máy, Shinhan Finance đã nỗ lực không ngừng để thích ứng với các quy định mới. Điểm nhấn của năm qua là việc triển khai Thông tư 15/2023/TT-NHNN, đặt ra yêu cầu cao hơn hẳn về chất lượng, tính kịp thời và độ chuẩn xác của dữ liệu báo cáo.</p>
<h3>Đồng hành xây dựng hệ sinh thái dữ liệu mở</h3>
<p>Không chỉ dừng lại ở thành tích năm 2025, giải thưởng này là động lực để Shinhan Finance tiếp tục chiến lược phát triển bền vững trong giai đoạn mới. Shinhan Finance cam kết sẽ tiếp tục ứng dụng các giải pháp công nghệ hiện đại trong phân tích và xếp hạng tín dụng.</p>`,
    category: 'su-kien',
    date: '2026-02-04',
  ...
  },
  {
    ...
    excerpt: 'Công ty Tài chính TNHH MTV Shinhan Việt Nam (Shinhan Finance) trân trọng thông báo đến Quý Khách hàng lịch nghỉ Tết Nguyên đán 2026.',
    content: `<p>Công ty Tài chính TNHH MTV Shinhan Việt Nam (Shinhan Finance) trân trọng thông báo đến Quý Khách hàng lịch nghỉ Tết Nguyên đán 2026 như sau:</p>
<ul>
...
<p>Shinhan Finance luôn sẵn sàng cung cấp các tiện ích để phục vụ Khách hàng tra cứu thông tin khoản vay trực tuyến và hỗ trợ 24/7 bao gồm:</p>
<ul>
...
<li>SVFC Bot tại tài khoản Zalo chính thức và Shinhan Finance Facebook Fanpage.</li>
</ul>
<p>Shinhan Finance trân trọng thông báo và kính chúc Quý Khách hàng và Gia đình một năm mới An Khang, Thịnh Vượng!</p>`,
    category: 'thong-bao',
    date: '2026-01-28',
  ...
  },
  {
    ...
    content: `<p>Với mục tiêu không ngừng nâng cao trải nghiệm dịch vụ và gia tăng quyền lợi cho khách hàng từ hệ sinh thái Shinhan Financial Group, Shinhan Finance phối hợp cùng Chứng khoán Shinhan Việt Nam (SSV) triển khai chương trình tặng quà chào mừng đặc biệt.</p>
...
<p>Truy cập ngay nền tảng tài chính số iShinhan phiên bản mới nhất để trải nghiệm dịch vụ chứng khoán.</p>`,
  ...
  },
  {
    ...
    title: 'Giải pháp vay tiêu dùng trả góp linh hoạt cùng Shinhan Finance',
    excerpt: 'Với hình thức vay tiêu dùng trả góp linh hoạt từ Shinhan Finance, bạn có thể dễ dàng tiếp cận nguồn tài chính mà không cần thế chấp tài sản.',
    content: `<p>Cuộc sống hiện đại ngày nay, nhu cầu tài chính ngày càng đa dạng, từ mua sắm đồ gia dụng, thiết bị điện tử đến trang trải các chi phí quan trọng. Với hình thức vay tiêu dùng trả góp linh hoạt từ Shinhan Finance, bạn có thể dễ dàng tiếp cận nguồn tài chính mà không cần thế chấp tài sản.</p>
...
<h2>Tại sao nên chọn vay tiêu dùng trả góp tại Shinhan Finance?</h2>
<ul>
